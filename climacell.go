...
var ccDescriptions = map[string]string{
	"clear":               "晴(Clear)",
	"mostly_clear":        "大部晴朗(Mostly sunny)",
	"partly_cloudy":       "局部多云(Partly cloudy)",
	"mostly_cloudy":       "大部多云(Mostly cloudy)",
	"cloudy":              "多云(Cloudy)",
	"fog":                 "雾(Fog)",
	"fog_light":           "薄雾(Light fog)",
	"drizzle":             "细雨(Drizzle)",
	"rain_light":          "小雨(Light rain)",
	"rain":                "雨(Rain)",
	"rain_heavy":          "大雨(Heavy rain)",
	"tstorm":              "雷雨(Thunderstorms)",
	"flurries":            "小雪(Flurries)",
	"snow_light":          "薄雪(Light snow)",
	"snow":                "雪(Snow)",
	"snow_heavy":          "大雪(Heavy snow)",
	"ice_pellets_light":   "小雨夹雪(Light sleet)",
	"ice_pellets":         "雨夹雪(Sleet)",
	"ice_pellets_heavy":   "大雨夹雪(Heavy sleet)",
	"freezing_drizzle":    "细冻雨(Freezing drizzle)",
	"freezing_rain_light": "小冻雨(Light freezing rain)",
	"freezing_rain":       "冻雨(Freezing rain)",
	"freezing_rain_heavy": "大冻雨(Heavy freezing rain)",
}
